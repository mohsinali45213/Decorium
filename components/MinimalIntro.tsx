...
export function MinimalIntro() {
  return (
    <section className="relative w-full h-[100dvh] flex flex-col justify-center items-center overflow-hidden px-navbar-px text-center bg-[#fdf8f8]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-lg mx-auto w-full px-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
        {/* Wordmark */}
        <h2 className="font-raleway text-display-lg text-[#1c1b1b] tracking-[0.25em] uppercase leading-none">
          DECORIUM
        </h2>
        ...
        {/* Tagline */}
        <p className="font-label-caps text-label-caps-sm text-[#5d5f5f] uppercase tracking-[0.3em]">
